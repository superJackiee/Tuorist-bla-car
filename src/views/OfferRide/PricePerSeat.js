...
const PricePerSeat = (props) => {
  ...
  const handleRadioChange = (event) => {
    ...
    if (event.target.value !== "can") setOpen(true);
  };
              ...
              <FormControl component="fieldset">
                ...
                >
                  ...
                  <FormControlLabel
                    value="cannot"
                    control={<Radio color="primary" />}
                    label="No, I’ll change the price"
                    labelPlacement="start"
                  />
                </RadioGroup>
              </FormControl>
...
const styles = {
  ...
  inputNumber: (isRowBased) => ({
    ...
    width: isRowBased ? "4vw" : "5vw",
    height: isRowBased ? "2.5vw" : "2.5vw",
    fontFamily: "Rubik",
    fontSize: isRowBased ? "1.7vw" : "2vw",
    textAlign: "center",
    fontWeight: "500",
    letterSpacing: "-0.33px",
    marginBottom: "3vw",
