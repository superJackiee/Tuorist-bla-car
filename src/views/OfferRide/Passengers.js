        ...
        <div className="text-center" style={styles.leftContainer(matches)}>
          ...
          <div className={classes.pane} style={styles.tabContainer}>
            ...
            <TabPanel value={value} index={0}>
              <span style={styles.txtDesc(matches)}>
          ...
          <div
            ...
            style={styles.radioContainer(matches)}
          >
            <Paper square>
...
const styles = {
  ...
  txtDesc: (isRowBased) => ({
    fontFamily: "Rubik",
    fontSize: isRowBased ? "1.15vw" : "2.5vw",
    fontWeight: "650",
    marginBottom: "2vw",
    marginTop: "1.5vw",
    display: "block",
  }),
  radioContainer: (isRowBased) => ({
    width: "70%",
    margin: "auto",
    marginBottom: "3vw",
    padding: "2vw 3vw",
  ...
  activeCircle: (isRowBased) => ({
    width: isRowBased ? "3.5vw" : "5vw",
    height: isRowBased ? "3.5vw" : "5vw",
    border: "none",
